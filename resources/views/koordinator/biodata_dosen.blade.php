            ...
            <!-- konten -->
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Biodata Dosen</h1>
                        ...
                        <i class='far fa-edit'></i>
                                ...
                                <form action="/Biodata Dosen/{{$data->id}}" method="post">
                                            @method('put')
                                            @csrf
                                            <div class="container">
                                    <div class="row">
                                     <div class="col-md-5">   
                                    <div class="row mb-3">
                                    <input type="text" name="kd_instruktur" class="form-control" aria-describedby="S" placeholder="kd Istruktur" value="{{$data->kd_instruktur}}">
                                    </div>
                    ...
                    <tr>
                        <td style="color: #999999;">Kode Instruktur</td>
                        <td style="color: #999999;">{{$data->kd_instruktur}}</td>                    
                    </tr>
                    <tr>
