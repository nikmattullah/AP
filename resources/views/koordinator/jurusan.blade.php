            ...
            <!-- konten -->
                <div class="container-fluid">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            ...
                            <div class="modal-body">
                                <form action="/Jurusan/store" method="post">
                                    @csrf
                                    <div class="container">
                                    <input type="text" name="kd_jurusan" class="form-control @error('kd_jurusan') is-invalid @enderror" aria-describedby="S" placeholder="Kode Jurusan">
                                    @error('kd_jurusan')
                                    ...
                                    <br>
                                    <div class="container">
                                    <input type="text" name="nm_jurusan" class="form-control @error('nm_jurusan') is-invalid @enderror" aria-describedby="S" placeholder="Nama Jurusan">
                                    @error('nm_jurusan')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                    ...
                    <tr align="center" style="background-color: #009DA5;">
                        ...
                        <th style="color: floralwhite; width:auto;">Kode Jurusan</th>
                        <th style="color: floralwhite; width:auto;">Nama Jurusan</th>
                    ...
                    <tr align="center">
                        ...
                        <form action="/Jurusan/{{$d->id}}" method="post">
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-body">
                                    Yakin Jurusan {{$d->nm_jurusan}} Ingin Di Hapus ?        
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    ...
                                    <div class="modal-body">
                                        <form action="/Jurusan/{{$d->id}}" method="post">
                                            ...
                                            @csrf
                                            <div class="container">
                                                <input type="text" name="kd_jurusan" class="form-control  @error('kd_jurusan') is-invalid @enderror" aria-describedby="S" value="{{$d->kd_jurusan}}">
                                                @error('kd_jurusan')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                                ...
                                                <br>
                                                <div class="container">
                                                <input type="text" name="nm_jurusan" class="form-control @error('nm_jurusan') is-invalid @enderror" aria-describedby="S" value="{{$d->nm_jurusan}}">
                                                @error('nm_jurusan')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
