            ...
            <!-- konten -->
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Usulan Judul Diterima</h1>            
                    </div>
                    
                    <form action="/Usulan Judul Diterima" method="post">
                        @csrf
                        @method('get')
                    <div class="row">
                    ...
                    <tr style="background-color: #009DA5;">
                        ...
                        <th style="color: floralwhite; width:auto;">Dosen Pembimbing</th>
                        ...
                        <td colspan="7">
                            <div class="container my-auto">
                                <div class="copyright text-left">
                                    <span style="color: red;"> <i>Belum Ada Judul Yang Diterima</i></span>
                                </div>
                            </div>
                        </td>
                    </tr>
