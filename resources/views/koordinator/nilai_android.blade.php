            ...
            <!-- konten -->
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Nilai Android</h1>
                        <!-- Tambah data -->
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Form Penilaian Android</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                            <form action="/Nilai Android/store" method="post" >
                                    @csrf
                                    <div class="container">
                                    <div class="row">
                                    <div class="col-md-7">   
                                    ...
                                    <input type="text" name="nama" class="form-control" aria-describedby="S" readonly="" value="" id="nama">
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                     ...
                                     <div class="col-md-4">
                                        ...
                                        <input type="number" class="form-control" name="performa" >
                                        </div>
                                        <div class="row mb-3">
                                            <label for="">Desain UI :</label>
                                        <input type="number" class="form-control" name="desen_ui" >
                                        </div>
                                        <div class="row mb-3">
                                            <label for="">Hasil Aplikasi :</label>
                                            <input type="number" class="form-control" name="hasil_aplikasi" >
                                        </div>                   
                                    </div>
                                    </div>
                            </div>
                    ...
                    <form action="/Nilai Android" method="post">
                        @csrf
                        @method('get')
                    <div class="row">
                    ...
                    <tr style="background-color: #009DA5;">
                        ...
                        <th style="color: floralwhite; width:auto; text-align: center;">Performa</th>
                        <th style="color: floralwhite; width:auto; text-align: center;">Desen UI</th>
                        <th style="color: floralwhite; width:auto; text-align: center;">Hasil Aplikasi</th>
                    ...
                    @forelse($android as $Pagination => $a)
                    <tr>
                        <td>{{$Pagination + $android->firstItem()}}</td>
                        <td>{{$a->biodata_mahasiswa->nim}}</td>
                        <td>{{$a->biodata_mahasiswa->nama}}</td>
                        <td style="text-align: center;">{{$a->penulisan}}</td>
                        <td style="text-align: center;">{{$a->performa}}</td>
                        <td style="text-align: center;">{{$a->desen_ui}}</td>
                        <td style="text-align: center;">{{$a->hasil_aplikasi}}</td>
                        <td style="text-align: center;">
                        <form action="/Nilai Android/{{$a->id}}" method="post">
                                <!-- Button Edit Data -->
                    ...
                    <div class="modal fade" id="edit{{$a->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Form Edit Penilaian Android</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                            <form action="/Nilai Android/{{$a->id}}" method="post" >
                                ...
                                @csrf
                                    ...
                                    <div class="row mb-3">
                                     ...
                                     <div class="col-md-4">
                                        <div class="row mb-3">
                                            <label for="">performa :</label>
                                        <input type="number" class="form-control" name="performa" value="{{$a->performa}}">
                                        </div>
                                        <div class="row mb-3">
                                            <label for="">Desain UI :</label>
                                        <input type="number" class="form-control" name="desen_ui" value="{{$a->desen_ui}}">
                                        </div>
                                        <div class="row mb-3">
                                            <label for="">Hasil Aplikasi :</label>
                                            <input type="number" class="form-control" name="hasil_aplikasi" value="{{$a->hasil_aplikasi}}">
                                        </div>                   
                                    </div>
                                    </div>
                            </div>
                            ...
                            <td colspan="8">
                                <div class="container my-auto">
                                    <div class="copyright text-left">
                                        <span style="color: red;"> <i>Belum Ada Data Nilai Android yang Ditambah</i></span>
                                    </div>
                                </div>
                            </td>
                        </tr> 
