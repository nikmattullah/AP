    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- konten -->
                ...
                <div class="col-md-6">
                <form action="/Upload File/{{$data->id}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('put')
                  <div class="row">
                        <div class="card">
                            <label>Judul:</label>
                            <input type="text" name="judul_penulisan" value="{{$data->judul_penulisan}}" class="form-control"/>
                            <label>Penulisan:</label>
                            <input type="file" name="penulisan" value="{{$data->penulisan}}" class="form-control @error('penulisan') is-invalid @enderror"/><br>
                                @error('penulisan')
                            ...
                            <label>Video:</label>
                            <input type="file" name="video" class="form-control @error('video') is-invalid @enderror"/><br>
                                @error('video')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <button type="submit" class="btn btn-info btn-sm" style="width: 80px;">Simpan</button>
                                    </div>

                                    <div class="col-md-3">
                                       <a href="/Upload File" class="btn btn-secondary btn-sm">Batal</a>
                                    </div>
                                </div><br>
                        </div>
                  </div>
