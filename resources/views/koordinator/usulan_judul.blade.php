            ...
            <!-- konten -->
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Usulan Judul</h1>

                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="/Usulan Judul Diterima" class="btn btn-info btn-sm" type="button">Judul Diterima </a>
                            <a href="/Usulan Judul Ditolak" class="btn btn-danger btn-sm" type="button">Judul Ditolak</a>
                        </div>             
                    </div>
                    <form action="/Usulan Judul" method="post">
                        @csrf
                        @method('get')
                    <div class="row">
                    ...
                    <tr style="background-color: #009DA5;">
                        ...
                        <th style="color: floralwhite; width:5cm;">Aksi</th>
                  ...
                  @forelse($data as $Pagination => $d)
                    ...
                    <div class="row">
                        <!-- button terima -->
                        <div class="col-md-4">                       
                            <form action="/Usulan Judul/{{$d->id}}" method="POST">
                            @method('put')
                            @csrf
                            <input type="hidden" name="biodata_mahasiswa" value="{{$d->biodata_mahasiswas_id}}">

                            <!-- Button Terima & modal pembagian pembimbing-->
                            <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#terima{{$d->id}}">
                                Terima
                            </button>

                            <!-- Modal pembagian pembimbing-->
                            <div class="modal fade" id="terima{{$d->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-info btn-sm" data-bs-dismiss="modal">Oke</button>                                    
                                    </div>
                                    </div>
                                </div>
                            </div>          
                        ...
                        <!-- button tolak -->
                        <div class="col-md-4">                       
                            <form action="/Usulan Judul/tolak/{{$d->id}}" method="POST">
                            @method('put')
                            @csrf
                            <input type="hidden" name="biodata_mahasiswa" value="{{$d->biodata_mahasiswas_id}}">
                            <button type="submit" name="terima" class="btn btn-danger btn-sm">Tolak</button>
                            </form>
                        </div> 
                        ...
                        <td colspan="6">
                            <div class="container my-auto">
                                <div class="copyright text-left">
                                    <span style="color: red;"> <i>Data Pengajuan Judul Belum Diserahkan </i></span>
                                </div>
                            </div>
                        </td>
                    </tr>
