            ...
            <!-- konten -->
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                       ...
                       @if($id_mhs == null)
                        <!-- Button Tambah Data -->
                        <a href="/Upload File/create" class="btn btn-info btn-sm">Tambah</a>
                       @else
                       <a href="/Upload File/{{$id_mhs->id}}/edit" class="btn btn-info btn-sm">Edit</a>
                       @endif
                    </div>
                   ...
                   @if($id_mhs == null)
                    <div class="container my-auto">
                        <div class="copyright text-left">
                            <span style="color: red;"> <i>File Penulisan Belum Diserahkan </i></span>
                        </div>
                    </div>
                   @else
                   <div class="col-md-6">
                    ...
                    <tr>
                        <td style="color: #999999;">"{{$id_mhs->judul_penulisan}}"</td>
                    ...
                    <tr>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            ...
                            <div class="modal-body">
                                <embed type="application/pdf" src="{{asset('Storage/File-Mahasiswa/'.$id_mhs->penulisan.' ')}}" width="760" height="500"></embed>
                            </div>
