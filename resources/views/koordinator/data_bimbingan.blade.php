        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- konten -->
                <div class="container-fluid">
                    ...
                    <form action="/Data Bimbingan" method="post">
                        @csrf
                        @method('get')
                    <div class="row">
                    ...
                    <div class="col-md-12">
                    <table class="table">
                    <tr style="background-color: #009DA5; text-align:center;">
                        ...
                        <th style="color: floralwhite; width:1cm;">Aksi</th>
                    </tr>
                  ...
                  @forelse($data as $Pagination => $d)
                    <tr>
                        ...
                        <td>
                            @if($d->checkbox == '1')
                            <form action="/Bimbinganuncheckbox/{{$d->id}}" method="post">
                                @csrf
                                @method('put')
                                <input type="checkbox" name="checkbox" id="" class="form-check-input mt-0" onchange="this.form.submit()" checked>
                            </form>
                            @else
                            <form action="/Bimbingancheckbox/{{$d->id}}" method="post">
                                @csrf
                                @method('put')
                                <input type="checkbox" name="checkbox" id="" class="form-check-input mt-0" onchange="this.form.submit()">
                            </form>
                            @endif
                        </td>
                    </tr>
                        ...
                        <td colspan="7">
                            <div class="container my-auto">
                                <div class="copyright text-left">
                                    <span style="color: red;"> <i>Data Bimbingan Belum Ada</i></span>
                                </div>
                            </div>
                        </td>
                    </tr>
