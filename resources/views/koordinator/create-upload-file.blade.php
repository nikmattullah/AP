            ...
            <!-- konten -->
                <div class="container-fluid">
                  ...
                  <div class="row">
                        <div class="card">
                            <label>Judul:</label>
                            <input type="text" name="judul_penulisan" class="form-control"/>
                            <label>Penulisan:</label>
                            <input type="file" name="penulisan" class="form-control @error('penulisan') is-invalid @enderror"/><br>
                                @error('penulisan')
                            ...
                            <input type="file" name="video" class="form-control @error('video') is-invalid @enderror"/><br>
                                ...
                                <button type="submit" class="btn btn-info btn-sm" style="width: 80px;">Simpan</button><br>
                        </div>
                  </div>
               </form>
                    </div>
