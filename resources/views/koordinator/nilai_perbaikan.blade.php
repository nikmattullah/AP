            ...
            <!-- konten -->
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Nilai Perbaikan</h1>
                        <!-- Tambah data -->
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Form Nilai Perbaikan</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                            <form action="/Nilai Perbaikan/store" method="post" >
                                    @csrf
                                    <div class="container">
                                    <div class="row"> 
                                    <div class="row mb-3">
                                    ...
                                    <input type="text" name="nama" id="nama" class="form-control" aria-describedby="S" readonly="" value="">
                                    </div>

                                    <div class="row mb-3">
                                        <label for="">Nilai Perbaikan :</label>
                                        <input type="number" class="form-control" name="nilai_perbaikan" style="width: 100px;">
                                    </div>                        
                    ...
                    <form action="/Nilai Perbaikan" method="post">
                        @csrf
                        @method('get')
                    <div class="row">
                    ...
                    <tr style="background-color: #009DA5;">
                        ...
                        <th style="color: floralwhite; width:auto;">Nilai Perbaikan</th>                        
                    ...
                    @forelse($perbaikan as $Pagination => $a)
                    <tr>
                        <td>{{$Pagination + $perbaikan->firstItem()}}</td>
                        <td>{{$a->biodata_mahasiswa->nim}}</td>
                        <td>{{$a->biodata_mahasiswa->nama}}</td>
                        <td style="text-align:center;">{{$a->nilai_perbaikan}}</td>
                        
                        <td>
                        <form action="/Nilai Perbaikan/{{$a->id}}" method="post">
                                <!-- Button Edit Data -->
                                ...
                                @method('delete')
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body">
                                            Yakin Nilai Perbaikan Mahasiswa a.n '{{$a->biodata_mahasiswa->nama}}' Ingin Dihapus?
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    ...
                    <div class="modal fade" id="edit{{$a->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Form Edit Nilai Perbaikan</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                            <form action="/Nilai Perbaikan/{{$a->id}}" method="post" >
                                ...
                                @csrf
                                    ...
                                    <div class="row mb-3">
                                        <label for="">Nilai Perbaikan :</label>
                                        <input type="number" class="form-control" name="nilai_perbaikan" value="{{$a->nilai_perbaikan}}" style="width: 100px;">
                                    </div>                              
                        ...
                        <td colspan="5">
                            <div class="container my-auto">
                                <div class="copyright text-left">
                                    <span style="color: red;"> <i>Data Nilai Perbaikan Belum Ada</i></span>
                                </div>
                            </div>
                        </td>
                    </tr>
