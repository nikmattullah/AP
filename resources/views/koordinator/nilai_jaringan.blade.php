            ...
            <!-- konten -->
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Nilai Jaringan</h1>
                        <!-- Tambah data -->
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Form Penilaian Jaringan</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                            <form action="/Nilai Jaringan/store" method="post" >
                                    @csrf
                                    <div class="container">
                                    <div class="row">
                                    <div class="">   
                                    ...
                                    <div class="row mb-3">
                                        <label for="">Penulisan :
                                            <input type="number" class="form-control" name="penulisan" style="width: 80px;">
                                        </label>
                                    </div>
                                        
                                    <div class="row mb-3">
                                        <label for="">Performa :
                                            <input type="number" class="form-control" name="performa" style="width: 80px;">
                                        </label>
                                    </div>  
                                    </div>                                    
                                    </div>
                    ...
                    <form action="/Nilai Jaringan" method="post">
                        @csrf
                        @method('get')
                    <div class="row">
                    ...
                    @forelse($jaringan as $Pagination => $a)
                    <tr>
                        <td>{{$Pagination + $jaringan->firstItem()}}</td>
                        ...
                        <td>
                        <form action="/Nilai Jaringan/{{$a->id}}" method="post">
                                <!-- Button Edit Data -->
                    ...
                    <div class="modal fade" id="edit{{$a->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Form Edit Penilaian Jaringan</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                            <form action="/Nilai Jaringan/{{$a->id}}" method="post" >
                                ...
                                @csrf
                                    ...
                                    <div class="row mb-3">
                                        <label for="">Penulisan :
                                            <input type="number" class="form-control" name="penulisan" value="{{$a->penulisan}}" style="width: 80px;">
                                        </label>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="">Performa :
                                            <input type="number" class="form-control" name="performa" value="{{$a->performa}}" style="width: 80px;">
                                        </label>
                                    </div>                                        
                                    </div>                                    
                                    </div>
                            ...
                            <td colspan="6">
                                <div class="container my-auto">
                                    <div class="copyright text-left">
                                        <span style="color: red;"> <i>Belum Ada Data Nilai Jaringan yang Ditambah</i></span>
                                    </div>
                                </div>
                            </td>
                        </tr>   
