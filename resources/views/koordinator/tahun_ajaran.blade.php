        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- konten -->
                <div class="container-fluid">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            ...
                            <div class="modal-body">
                                <form action="/Tahun Ajaran/store" method="post">
                                    @csrf
                                    <div class="container">
                                    <input type="text" name="tahun_ajaran" class="form-control  @error('tahun_ajaran') is-invalid @enderror" aria-describedby="S">
                                    @error('tahun_ajaran')
                    ...
                    <div class="col-md-5">
                    <table class="table">
                    <tr style="background-color: #009DA5;" align="center">
                        <th style="color: floralwhite; width:8mm;">NO</th>
                        <th style="color: floralwhite; width:auto;">Tahun Ajaran</th>
                    ...
                    <tr align="center">
                        ...
                        <td>
                            <form action="/Tahun Ajaran/{{$d->id}}" method="POST">
                                  <!-- Button Edit Data -->
                                ...
                                @method('delete')
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body">
                                            Yakin Tahun Ajaran {{$d->tahun_ajaran}} Ingin Dihapus?
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    ...
                                    <div class="modal-body">
                                        <form action="/Tahun Ajaran/{{$d->id}}" method="post">
                                            ...
                                            @csrf
                                            <div class="">
                                            <input type="number" name="tahun_ajaran" class="form-control" aria-describedby="S" value="{{$d->tahun_ajaran}}">
                                            </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
